...
import {
    ...
    SONG_LIST_SORTED, SONG_LIST_QUEUE_ADDED, SONG_LIST_QUEUE_ORDERED,
    SONG_LIST_MENU_OPENED
...
export const songListQueueOrdered = req => buildAction(SONG_LIST_QUEUE_ORDERED, req);
